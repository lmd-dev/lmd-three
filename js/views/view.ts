class View implements Observer
{
    ...
    //Objects maps
    private _objects: Map<string, THREE.Object3D>;
    ...
    constructor(controller: Controller)
    {
        ...
        this._camera = null;
        this._renderer = null;
        this._objects = new Map<string, THREE.Object3D>();
    ...
    createCube()
    {
        ...
        (<THREE.DirectionalLight>this._objects.get('light')).target = cube;
    }
    ...
    createLandscape()
    {
        ...
        let vertices = <Array<number>>geometry.attributes.position.array;
        ...
        (<THREE.DirectionalLight>this._objects.get('light')).target = plan;
    }
